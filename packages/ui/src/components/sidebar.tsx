// biome-ignore-all lint/suspicious/noDocumentCookie: shadcn sidebar persists collapse state with the registry cookie pattern.
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@saas-boilerplate/ui/components/sheet";
...
import { useIsMobile } from "@saas-boilerplate/ui/hooks/use-mobile";
