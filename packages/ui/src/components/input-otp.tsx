// biome-ignore-all lint/a11y/useAriaPropsForRole: shadcn OTP separator follows the registry decorative separator pattern.
// biome-ignore-all lint/a11y/useFocusableInteractive: shadcn OTP separator is decorative and not keyboard interactive.
// biome-ignore-all lint/a11y/useSemanticElements: shadcn OTP separator preserves the registry slot contract.
