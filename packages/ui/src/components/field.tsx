// biome-ignore-all lint/a11y/useSemanticElements: shadcn field uses generic wrapper slots for field composition.
// biome-ignore-all lint/suspicious/noArrayIndexKey: shadcn field errors render de-duplicated messages without stable ids.
